...
public class AnalysisRepositoryImpl implements AnalysisRepository {
  ...
  @Override
  public List<Analysis> findByTransformerIdAndAnalysisDateBetween(
  ...
  public List<Analysis> findByAnalysisDateBetween(LocalDate s, LocalDate e) {
    return jpa.findByAnalysisDateBetween(s, e).stream()
        .map(AnalysisRepositoryImpl::toDomain)
        .toList();
  }
  ...
  public Optional<Analysis> findLatestByTransformerId(Long transformerId) {
    return jpa.findTop1ByTransformerIdOrderByAnalysisDateDescIdDesc(transformerId)
        .map(AnalysisRepositoryImpl::toDomain);
  }
}
