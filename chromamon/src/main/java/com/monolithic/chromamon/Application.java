...
@EnableMongoRepositories(basePackages = {"com.monolithic.chromamon.audit.infrastructure.persistence"})
@EnableJpaAuditing
@EnableAsync
@EnableScheduling
...
public class Application {
   ...
   public static void main(String[] args) {
      ...
      log.info("--- Chromamon app started successfully in {} ms ---", Duration.between(start, end).toMillis());
      log.info(String.join("", Collections.nCopies(100, "-")));
   }
