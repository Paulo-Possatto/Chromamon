...
public class LoginController {
  ...
  @Operation(
      ...
      tags = {SwaggerConstants.TAG_USER, SwaggerConstants.TAG_AUTHENTICATION},
      ...
      responses = {
                ...
                @Content(
                    ...
                    examples = {
                      @ExampleObject(
                          name = "Blank email",
                          description =
                              "400 error response for when the email parameter is not added in the request",
                          value =
                              """
                        {
                      ...
                      @ExampleObject(
                          name = "Wrong email",
                          description =
                              "400 error response for when the email parameter does not have the correct format",
                          value =
                              """
                        {
                      ...
                      @ExampleObject(
                          name = "Blank password",
                          description =
                              "400 error response for when the password parameter is blank",
                          value =
                              """
                        {
                      ...
                      @ExampleObject(
                          name = "Size password",
                          description =
                              "400 error response for when the password parameter is too short or too long",
                          value =
                              """
                        {
                      ...
                      @ExampleObject(
                          ...
                          description =
                              "400 error response for when the password does not satisfies the required characters",
                          value =
                              """
                        {
                ...
                @Content(
                    ...
                    examples = {
                      ...
                      @ExampleObject(
                          name = "User Inactive",
                          description =
                              "401 error response for when the user is set to inactive in the database",
                          value =
                              """
                        {
                            "timestamp": "2025-08-29T19:27:52.019612812",
        ...
        @ApiResponse(
            responseCode = "500",
            description =
                "Some internal error happened, this needs to be verified by the IT department",
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema =
  ...
  public ResponseEntity<LoginResponse> login(
      @Valid @RequestBody @Parameter(hidden = true) LoginRequest loginRequest) {
