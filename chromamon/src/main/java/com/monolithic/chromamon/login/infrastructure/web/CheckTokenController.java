...
public class CheckTokenController {
  ...
  @Operation(
      ...
      tags = {SwaggerConstants.TAG_AUTHENTICATION},
      parameters = {
        @Parameter(
            name = "token",
      ...
      responses = {
        ...
        @ApiResponse(
            responseCode = "500",
            description =
                "Some error occurred while validating the token (probably the token was not sent), contact the IT",
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema =
  ...
  public ResponseEntity<Boolean> validateToken(@RequestParam @NotBlank(message = "") String token) {
